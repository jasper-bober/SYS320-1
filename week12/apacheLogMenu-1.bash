...
#my access.log didnt have anything.The commented log file variable was so I could test it with actual logs
...
do
	...
	# (DONE) Display a message, if an invalid input is given
